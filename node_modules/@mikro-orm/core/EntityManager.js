...
class EntityManager {
    ...
    async upsert(entityNameOrEntity, data, options = {}) {
        ...
        if (em.eventManager.hasListeners(enums_1.EventType.beforeUpsert, meta)) {
            await em.eventManager.dispatchEvent(enums_1.EventType.beforeUpsert, { entity: data, em }, meta);
        }
        ...
        if (em.eventManager.hasListeners(enums_1.EventType.afterUpsert, meta)) {
            await em.eventManager.dispatchEvent(enums_1.EventType.afterUpsert, { entity, em }, meta);
        }
        return entity;
    }
    /**
    ...
    async upsertMany(entityNameOrEntity, data, options = {}) {
        ...
        if (em.eventManager.hasListeners(enums_1.EventType.beforeUpsert, meta)) {
            for (const dto of data) {
                ...
                await em.eventManager.dispatchEvent(enums_1.EventType.beforeUpsert, { entity, em }, meta);
            }
        }
